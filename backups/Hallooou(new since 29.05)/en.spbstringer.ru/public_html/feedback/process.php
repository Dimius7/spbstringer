...
$output .= "Телефон: " . $phone . "\n";
    ...
    $mail->From      = 'info@spbstringer.ru';
    $mail->FromName  = 'Сайт Stringers of St. Petersburg';
    $mail->Subject   = 'Сообщение с feedback form англоязычной версии сайта ';
    $mail->Body      = $output;
    $mail->AddAddress( 'info@spbstringer.ru' );
    $mail->CharSet = 'utf-8';
